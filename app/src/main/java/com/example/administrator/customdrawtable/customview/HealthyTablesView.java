package com.example.administrator.customdrawtable.customview;
...
import com.example.administrator.customdrawtable.R;
   ...
   * 折线颜色*/
    ...
    * 大圆填充色*/
    ...
    public HealthyTablesView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //在此方法中获得自定义控件的属性值
        TypedArray array = context.getTheme().obtainStyledAttributes(attrs, R.styleable.HealthyTableView, defStyleAttr, 0);
